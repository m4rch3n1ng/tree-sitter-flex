...
enum ts_symbol_identifiers {
  ...
  anon_sym_QMARK = 23,
  anon_sym_PIPE = 24,
  aux_sym__rule_token_token1 = 25,
  anon_sym_LT = 26,
  anon_sym_GT = 27,
  anon_sym_DQUOTE = 28,
  aux_sym_string_token1 = 29,
  aux_sym_embedded_code_token1 = 30,
  sym_trailing_code = 31,
  sym_source_file = 32,
  sym_comment = 33,
  aux_sym__comments = 34,
  sym_prologue = 35,
  sym_alias = 36,
  sym_section1 = 37,
  sym_escaped = 38,
  sym_interpolation = 39,
  sym__bracketed_token = 40,
  sym__bracketed_tokens = 41,
  sym__bracketed = 42,
  sym__rule_token = 43,
  sym_rule = 44,
  sym_state = 45,
  ...
  aux_sym__bracketed_tokens_repeat1 = 51,
  aux_sym_rule_repeat1 = 52,
  aux_sym_section2_repeat1 = 53,
};
  ...
  switch (state) {
    case 0:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(0);
      if (set_contains(sym_identifier_character_set_1, 685, lookahead)) ADVANCE(36);
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [aux_sym__comments] = STATE(34),
    [sym_prologue] = STATE(46),
    [sym_alias] = STATE(82),
    [sym_section1] = STATE(2),
    [aux_sym_section1_repeat1] = STATE(42),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [43] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(138),
  [46] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(145),
  ...
  [55] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(129),
  [58] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(146),
  [61] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_rule, 1, 0, 0),
  ...
  [73] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0),
  [75] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(110),
  [78] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(112),
  [81] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(64),
  [84] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(8),
  [87] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(122),
  ...
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule, 1, 0, 0),
  [118] = {.entry = {.count = 1, .reusable = false}}, SHIFT(15),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0),
  [122] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(138),
  [125] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(145),
  [128] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(65),
  [131] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(15),
  [134] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(146),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 1, 0, 0),
  [139] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 1, 0, 0),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 2, 0, 0),
  [143] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 2, 0, 0),
  ...
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 4, 0, 0),
  [155] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 4, 0, 0),
  [157] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_interpolation, 3, 0, 0),
  [159] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__bracketed, 3, 0, 0),
  [161] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 3, 0, 0),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 3, 0, 0),
  [165] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 3, 0, 0),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 5, 0, 0),
  [169] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 5, 0, 0),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 4, 0, 0),
  [173] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 4, 0, 0),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 6, 0, 0),
  [177] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 6, 0, 0),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 5, 0, 0),
  [181] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 5, 0, 0),
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 7, 0, 0),
  [185] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 7, 0, 0),
  [187] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 6, 0, 0),
  [189] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 6, 0, 0),
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 8, 0, 0),
  [193] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 8, 0, 0),
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 9, 0, 0),
  [197] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 9, 0, 0),
  ...
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_escaped, 2, 0, 0),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__bracketed, 2, 0, 0),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpolation, 3, 0, 0),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__bracketed, 3, 0, 0),
  ...
  [235] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_state, 3, 0, 0),
  [237] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_state, 3, 0, 0),
  [239] = {.entry = {.count = 1, .reusable = false}}, SHIFT(115),
  [241] = {.entry = {.count = 1, .reusable = false}}, SHIFT(30),
  [243] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__comments, 2, 0, 0),
  [245] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__comments, 2, 0, 0), SHIFT_REPEAT(96),
  [248] = {.entry = {.count = 1, .reusable = false}}, SHIFT(144),
  [250] = {.entry = {.count = 1, .reusable = false}}, SHIFT(63),
  [252] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__bracketed_tokens, 1, 0, 0),
  [254] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 2, 0, 0), SHIFT_REPEAT(104),
  [257] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 2, 0, 0),
  [259] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 2, 0, 0), SHIFT_REPEAT(10),
  [262] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__bracketed_tokens_repeat1, 2, 0, 0), SHIFT_REPEAT(144),
  [265] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__bracketed_tokens_repeat1, 2, 0, 0), SHIFT_REPEAT(62),
  [268] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__bracketed_tokens_repeat1, 2, 0, 0),
  [270] = {.entry = {.count = 1, .reusable = false}}, SHIFT(62),
  [272] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__bracketed_tokens, 2, 0, 0),
  ...
  [280] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 4, 0, 0),
  [282] = {.entry = {.count = 1, .reusable = true}}, SHIFT(106),
  [284] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_prologue, 3, 0, 0),
  [286] = {.entry = {.count = 1, .reusable = true}}, SHIFT(115),
  [288] = {.entry = {.count = 1, .reusable = true}}, SHIFT(147),
  [290] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 3, 0, 0),
  ...
  [314] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alias, 4, 0, 0),
  [316] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 3, 0, 0),
  [318] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 3, 0, 0),
  [320] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 2, 0, 0),
  [322] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 2, 0, 0),
  [324] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 4, 0, 0),
  [326] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 4, 0, 0),
  ...
  [338] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alias, 3, 0, 0),
  [340] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 1, 0, 0),
  [342] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 1, 0, 0),
  [344] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alias, 2, 0, 0),
  [346] = {.entry = {.count = 1, .reusable = true}}, SHIFT(116),
  [348] = {.entry = {.count = 1, .reusable = false}}, SHIFT(135),
  [350] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_embedded_code, 3, 0, 0),
  [352] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_embedded_code, 3, 0, 0),
  ...
  [402] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 2, 0, 0),
  ...
  [418] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 4, 0, 0),

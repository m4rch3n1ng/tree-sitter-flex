...
enum ts_symbol_identifiers {
  ...
  anon_sym_BSLASH = 12,
  aux_sym_escaped_token1 = 13,
  anon_sym_LBRACE = 14,
  anon_sym_RBRACE = 15,
  aux_sym__bracketed_token_token1 = 16,
  anon_sym_CARET = 17,
  anon_sym_DASH = 18,
  anon_sym_LBRACK = 19,
  anon_sym_RBRACK = 20,
  ...
  anon_sym_LPAREN = 25,
  anon_sym_RPAREN = 26,
  aux_sym__rule_token_token1 = 27,
  anon_sym_LT = 28,
  anon_sym_GT = 29,
  anon_sym_DQUOTE = 30,
  aux_sym_string_token1 = 31,
  aux_sym_embedded_code_token1 = 32,
  sym_trailing_code = 33,
  sym_source_file = 34,
  sym_comment = 35,
  aux_sym__comments = 36,
  aux_sym__inline_comments = 37,
  sym_prologue = 38,
  sym_alias = 39,
  sym_section1 = 40,
  sym_escaped = 41,
  sym_interpolation = 42,
  sym__bracketed_token = 43,
  sym__bracketed_tokens = 44,
  sym__bracketed = 45,
  sym__rule_token = 46,
  sym_rule = 47,
  sym_state = 48,
  sym_string = 49,
  sym_embedded_code = 50,
  sym_declaration = 51,
  sym_section2 = 52,
  aux_sym_section1_repeat1 = 53,
  aux_sym__bracketed_tokens_repeat1 = 54,
  aux_sym_rule_repeat1 = 55,
  aux_sym_section2_repeat1 = 56,
};
  ...
  switch (state) {
    case 0:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(0);
      if (set_contains(sym_identifier_character_set_1, 685, lookahead)) ADVANCE(38);
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_prologue] = STATE(50),
    [sym_alias] = STATE(83),
    [sym_section1] = STATE(2),
    [aux_sym_section1_repeat1] = STATE(85),
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(127)] = 2291,
  [SMALL_STATE(128)] = 2295,
  [SMALL_STATE(129)] = 2299,
  [SMALL_STATE(130)] = 2303,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0),
  [39] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0),
  [41] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(146),
  [44] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(154),
  [47] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(53),
  [50] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(13),
  [53] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(127),
  [56] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(155),
  ...
  [87] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(130),
  [90] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(151),
  [93] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(54),
  [96] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(11),
  [99] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(135),
  [102] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_rule, 1, 0, 0),
  [104] = {.entry = {.count = 1, .reusable = false}}, SHIFT(11),
  [106] = {.entry = {.count = 1, .reusable = false}}, SHIFT(14),
  [108] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(146),
  [111] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(154),
  [114] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(53),
  [117] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(14),
  [120] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(155),
  ...
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 2, 0, 0),
  [135] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 2, 0, 0),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 8, 0, 0),
  [139] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 8, 0, 0),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 1, 0, 0),
  [143] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 1, 0, 0),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 3, 0, 0),
  [147] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 3, 0, 0),
  [149] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_escaped, 2, 0, 0),
  [151] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__bracketed, 2, 0, 0),
  [153] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__inline_comments, 2, 0, 0), SHIFT_REPEAT(124),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__inline_comments, 2, 0, 0),
  [158] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__inline_comments, 2, 0, 0),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 2, 0, 0),
  [162] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 2, 0, 0),
  ...
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 6, 0, 0),
  [184] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 6, 0, 0),
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 5, 0, 0),
  [188] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 5, 0, 0),
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 7, 0, 0),
  [192] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 7, 0, 0),
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 6, 0, 0),
  [196] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 6, 0, 0),
  [198] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 7, 0, 0),
  [200] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 7, 0, 0),
  [202] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 4, 0, 0),
  [204] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 4, 0, 0),
  [206] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [208] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__inline_comments, 1, 0, 0),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 3, 0, 0),
  [212] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment, 3, 0, 0),
  [214] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 2, 0, 0),
  [216] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment, 2, 0, 0),
  [218] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_state, 3, 0, 0),
  [220] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_state, 3, 0, 0),
  ...
  [256] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__bracketed_tokens, 2, 0, 0),
  [258] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [260] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__bracketed_tokens_repeat1, 2, 0, 0), SHIFT_REPEAT(153),
  [263] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__bracketed_tokens_repeat1, 2, 0, 0), SHIFT_REPEAT(60),
  [266] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__bracketed_tokens_repeat1, 2, 0, 0),
  [268] = {.entry = {.count = 1, .reusable = false}}, SHIFT(56),
  [270] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__bracketed_tokens, 1, 0, 0),
  [272] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__comments, 2, 0, 0), SHIFT_REPEAT(121),
  [275] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__comments, 2, 0, 0),
  [277] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__comments, 2, 0, 0),
  [279] = {.entry = {.count = 1, .reusable = true}}, SHIFT(84),
  [281] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 2, 0, 0),
  ...
  [293] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 4, 0, 0),
  [295] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [297] = {.entry = {.count = 1, .reusable = true}}, SHIFT(73),
  [299] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 3, 0, 0),
  [301] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_section1_repeat1, 3, 0, 0),
  [303] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_section1_repeat1, 4, 0, 0),
  [305] = {.entry = {.count = 1, .reusable = false}}, SHIFT(90),
  [307] = {.entry = {.count = 1, .reusable = false}}, SHIFT(29),
  [309] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 5, 0, 0),
  [311] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_section1_repeat1, 5, 0, 0),
  [313] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 6, 0, 0),
  [315] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_section1_repeat1, 6, 0, 0),
  ...
  [325] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__inline_comments, 2, 0, 0), SHIFT_REPEAT(122),
  [328] = {.entry = {.count = 1, .reusable = false}}, SHIFT(102),
  [330] = {.entry = {.count = 1, .reusable = false}}, SHIFT(65),
  [332] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 2, 0, 0), SHIFT_REPEAT(7),
  [335] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_section1_repeat1, 2, 0, 0),
  ...
  [349] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prologue, 3, 0, 0),
  [351] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_prologue, 3, 0, 0),
  [353] = {.entry = {.count = 1, .reusable = true}}, SHIFT(69),
  [355] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alias, 4, 0, 0),
  [357] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 3, 0, 0),
  [359] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 3, 0, 0),
  [361] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alias, 3, 0, 0),
  [363] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 4, 0, 0),
  [365] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 4, 0, 0),
  ...
  [373] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_embedded_code, 3, 0, 0),
  [375] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alias, 2, 0, 0),
  [377] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 2, 0, 0),
  [379] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 2, 0, 0),
  [381] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 1, 0, 0),
  [383] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 1, 0, 0),
  [385] = {.entry = {.count = 1, .reusable = false}}, SHIFT(66),
  ...
  [421] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 4, 0, 0),

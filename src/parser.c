...
enum ts_symbol_identifiers {
  ...
  aux_sym__bracketed_token_token1 = 14,
  anon_sym_CARET = 15,
  anon_sym_DASH = 16,
  anon_sym_LBRACK = 17,
  anon_sym_RBRACK = 18,
  ...
  anon_sym_QMARK = 21,
  anon_sym_PIPE = 22,
  aux_sym__rule_token_token1 = 23,
  anon_sym_LT = 24,
  anon_sym_GT = 25,
  anon_sym_DQUOTE = 26,
  aux_sym_string_token1 = 27,
  anon_sym_LBRACE = 28,
  aux_sym_embedded_code_token1 = 29,
  anon_sym_RBRACE = 30,
  ...
  sym_section1 = 37,
  sym_escaped = 38,
  sym__bracketed_token = 39,
  sym__bracketed_tokens = 40,
  sym__bracketed = 41,
  sym__rule_token = 42,
  sym_rule = 43,
  sym_state = 44,
  sym_string = 45,
  sym_embedded_code = 46,
  sym_declaration = 47,
  sym_section2 = 48,
  aux_sym_section1_repeat1 = 49,
  aux_sym__bracketed_tokens_repeat1 = 50,
  aux_sym_rule_repeat1 = 51,
  aux_sym_section2_repeat1 = 52,
};
  ...
  switch (state) {
    case 0:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(0);
      if (set_contains(sym_identifier_character_set_1, 685, lookahead)) ADVANCE(39);
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [aux_sym__comments] = STATE(20),
    [sym_prologue] = STATE(49),
    [sym_alias] = STATE(83),
    [sym_section1] = STATE(2),
    [aux_sym_section1_repeat1] = STATE(41),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [41] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(137),
  [44] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(64),
  [47] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(7),
  [50] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(128),
  [53] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(143),
  [56] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_rule, 1, 0, 0),
  [58] = {.entry = {.count = 1, .reusable = false}}, SHIFT(8),
  [60] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0),
  [62] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(137),
  [65] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(64),
  [68] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(8),
  [71] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(143),
  [74] = {.entry = {.count = 1, .reusable = false}}, SHIFT(133),
  [76] = {.entry = {.count = 1, .reusable = false}}, SHIFT(59),
  [78] = {.entry = {.count = 1, .reusable = false}}, SHIFT(10),
  [80] = {.entry = {.count = 1, .reusable = false}}, SHIFT(111),
  [82] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(133),
  [85] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(59),
  [88] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(10),
  [91] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(111),
  ...
  [116] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_escaped, 2, 0, 0),
  [118] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__bracketed, 2, 0, 0),
  [120] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__bracketed, 3, 0, 0),
  ...
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 2, 0, 0),
  [134] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 2, 0, 0),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 4, 0, 0),
  [138] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 4, 0, 0),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 3, 0, 0),
  [142] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 3, 0, 0),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 5, 0, 0),
  [146] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 5, 0, 0),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 4, 0, 0),
  [150] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 4, 0, 0),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 6, 0, 0),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 6, 0, 0),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 5, 0, 0),
  [158] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 5, 0, 0),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 7, 0, 0),
  [162] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 7, 0, 0),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 6, 0, 0),
  [166] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 6, 0, 0),
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 8, 0, 0),
  [170] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 8, 0, 0),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 9, 0, 0),
  [174] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 9, 0, 0),
  [176] = {.entry = {.count = 1, .reusable = false}}, SHIFT(103),
  [178] = {.entry = {.count = 1, .reusable = false}}, SHIFT(36),
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 3, 0, 0),
  [182] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 3, 0, 0),
  [184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 1, 0, 0),
  [186] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 1, 0, 0),
  ...
  [194] = {.entry = {.count = 1, .reusable = false}}, SHIFT(45),
  ...
  [206] = {.entry = {.count = 1, .reusable = false}}, SHIFT(115),
  ...
  [214] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__comments, 2, 0, 0),
  [216] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__comments, 2, 0, 0), SHIFT_REPEAT(100),
  ...
  [225] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 2, 0, 0), SHIFT_REPEAT(132),
  [228] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 2, 0, 0),
  [230] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 2, 0, 0), SHIFT_REPEAT(11),
  [233] = {.entry = {.count = 1, .reusable = false}}, SHIFT(62),
  [235] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__bracketed_tokens, 2, 0, 0),
  [237] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__bracketed_tokens_repeat1, 2, 0, 0), SHIFT_REPEAT(142),
  [240] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__bracketed_tokens_repeat1, 2, 0, 0), SHIFT_REPEAT(62),
  [243] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__bracketed_tokens_repeat1, 2, 0, 0),
  [245] = {.entry = {.count = 1, .reusable = false}}, SHIFT(61),
  [247] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__bracketed_tokens, 1, 0, 0),
  ...
  [267] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 4, 0, 0),
  ...
  [281] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 3, 0, 0),
  [283] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_prologue, 3, 0, 0),
  ...
  [295] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alias, 3, 0, 0),
  ...
  [303] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alias, 4, 0, 0),
  [305] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 2, 0, 0),
  [307] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 2, 0, 0),
  [309] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 3, 0, 0),
  [311] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 3, 0, 0),
  [313] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 4, 0, 0),
  [315] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 4, 0, 0),
  [317] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [319] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 1, 0, 0),
  [321] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 1, 0, 0),
  [323] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alias, 2, 0, 0),
  [325] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_embedded_code, 3, 0, 0),
  [327] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_embedded_code, 3, 0, 0),
  [329] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 3, 0, 0),
  ...
  [341] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 4, 0, 0),
  ...
  [379] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 3, 0, 0),

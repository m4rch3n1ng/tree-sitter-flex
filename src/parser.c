  ...
  switch (state) {
    case 0:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(0);
      if (set_contains(sym_identifier_character_set_1, 685, lookahead)) ADVANCE(35);
    ...
    case 33:
      ...
      if (set_contains(sym_identifier_character_set_2, 800, lookahead)) ADVANCE(35);
      END_STATE();
    case 34:
      ACCEPT_TOKEN(sym_identifier);
      if (lookahead == '%') ADVANCE(40);
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [aux_sym__comments] = STATE(48),
    [sym_prologue] = STATE(49),
    [sym_alias] = STATE(67),
    [sym_section1] = STATE(2),
    [aux_sym_section1_repeat1] = STATE(106),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [41] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(144),
  [44] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(150),
  [47] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(63),
  [50] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(14),
  [53] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(128),
  [56] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(151),
  ...
  [79] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_rule, 1, 0, 0),
  [81] = {.entry = {.count = 1, .reusable = false}}, SHIFT(12),
  [83] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0),
  [85] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(138),
  [88] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(136),
  [91] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(52),
  [94] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(12),
  [97] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(137),
  [100] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(144),
  [103] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(150),
  [106] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(63),
  [109] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(13),
  [112] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(151),
  ...
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__inline_comments, 2, 0, 0),
  [129] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__inline_comments, 2, 0, 0), SHIFT_REPEAT(118),
  [132] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__inline_comments, 2, 0, 0),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 2, 0, 0),
  [136] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 2, 0, 0),
  [138] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_escaped, 2, 0, 0),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 1, 0, 0),
  [142] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 1, 0, 0),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 2, 0, 0),
  [146] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 2, 0, 0),
  ...
  [156] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__bracketed, 2, 0, 0),
  ...
  [164] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__bracketed, 3, 0, 0),
  ...
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 5, 0, 0),
  [174] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 5, 0, 0),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 4, 0, 0),
  [178] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 4, 0, 0),
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 6, 0, 0),
  [182] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 6, 0, 0),
  [184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 5, 0, 0),
  [186] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 5, 0, 0),
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section1, 7, 0, 0),
  [190] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 7, 0, 0),
  [192] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 6, 0, 0),
  [194] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 6, 0, 0),
  [196] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 7, 0, 0),
  [198] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 7, 0, 0),
  [200] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 8, 0, 0),
  [202] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 8, 0, 0),
  [204] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment, 2, 0, 0),
  [206] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment, 3, 0, 0),
  [208] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_state, 3, 0, 0),
  [210] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_state, 3, 0, 0),
  ...
  [240] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__bracketed_tokens, 2, 0, 0),
  [242] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__bracketed_tokens_repeat1, 2, 0, 0), SHIFT_REPEAT(149),
  [245] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__bracketed_tokens_repeat1, 2, 0, 0), SHIFT_REPEAT(55),
  [248] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__bracketed_tokens_repeat1, 2, 0, 0),
  [250] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [252] = {.entry = {.count = 1, .reusable = false}}, SHIFT(53),
  [254] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__bracketed_tokens, 1, 0, 0),
  ...
  [272] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 1, 0, 0),
  [274] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__comments, 2, 0, 0), SHIFT_REPEAT(117),
  [277] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__comments, 2, 0, 0),
  [279] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__comments, 2, 0, 0),
  ...
  [289] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 2, 0, 0),
  ...
  [301] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 3, 0, 0),
  [303] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_section1_repeat1, 3, 0, 0),
  ...
  [315] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_alias, 3, 0, 0),
  [317] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alias, 3, 0, 0),
  [319] = {.entry = {.count = 1, .reusable = true}}, SHIFT(97),
  [321] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_alias, 5, 0, 0),
  [323] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alias, 5, 0, 0),
  [325] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_alias, 2, 0, 0),
  [327] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alias, 2, 0, 0),
  [329] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [331] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_alias, 6, 0, 0),
  [333] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alias, 6, 0, 0),
  [335] = {.entry = {.count = 1, .reusable = true}}, SHIFT(102),
  [337] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [339] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prologue, 3, 0, 0),
  [341] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_prologue, 3, 0, 0),
  [343] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_alias, 7, 0, 0),
  [345] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alias, 7, 0, 0),
  [347] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [349] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [351] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 2, 0, 0), SHIFT_REPEAT(7),
  [354] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_alias, 4, 0, 0),
  [356] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alias, 4, 0, 0),
  ...
  [364] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_embedded_code, 3, 0, 0),
  [366] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 3, 0, 0),
  [368] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 3, 0, 0),
  [370] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 1, 0, 0),
  [372] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 1, 0, 0),
  [374] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 4, 0, 0),
  [376] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 4, 0, 0),
  [378] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 2, 0, 0),
  [380] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 2, 0, 0),
  ...
  [396] = {.entry = {.count = 1, .reusable = false}}, SHIFT(28),
  ...
  [404] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 4, 0, 0),
  [406] = {.entry = {.count = 1, .reusable = true}}, SHIFT(24),
  [408] = {.entry = {.count = 1, .reusable = true}}, SHIFT(26),
  [410] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 2, 0, 0),
  ...
  [422] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 3, 0, 0),

...
enum ts_symbol_identifiers {
  ...
  anon_sym_LBRACE = 15,
  aux_sym_embedded_code_token1 = 16,
  anon_sym_RBRACE = 17,
  sym_trailing_code = 18,
  sym_source_file = 19,
  sym_comment = 20,
  aux_sym__comments = 21,
  sym_prologue = 22,
  sym_alias = 23,
  sym_section1 = 24,
  sym_string = 25,
  sym_embedded_code = 26,
  sym_declaration = 27,
  sym_section2 = 28,
  aux_sym_section1_repeat1 = 29,
  aux_sym_section2_repeat1 = 30,
};
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [aux_sym__comments] = STATE(3),
    [sym_prologue] = STATE(18),
    [sym_alias] = STATE(56),
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(98)] = 1289,
  [SMALL_STATE(99)] = 1293,
  [SMALL_STATE(100)] = 1297,
  [SMALL_STATE(101)] = 1301,
  [SMALL_STATE(102)] = 1305,
  [SMALL_STATE(103)] = 1309,
  [SMALL_STATE(104)] = 1313,
  [SMALL_STATE(105)] = 1317,
  [SMALL_STATE(106)] = 1321,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [27] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 1, 0, 0),
  ...
  [51] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 2, 0, 0),
  [53] = {.entry = {.count = 1, .reusable = false}}, SHIFT(11),
  [55] = {.entry = {.count = 1, .reusable = false}}, SHIFT(97),
  [57] = {.entry = {.count = 1, .reusable = false}}, SHIFT(61),
  [59] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__comments, 2, 0, 0),
  [61] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__comments, 2, 0, 0), SHIFT_REPEAT(77),
  ...
  [74] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 2, 0, 0), SHIFT_REPEAT(87),
  [77] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 2, 0, 0),
  [79] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 2, 0, 0), SHIFT_REPEAT(78),
  ...
  [92] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 3, 0, 0),
  [94] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0),
  [96] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(5),
  [99] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(82),
  [102] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_embedded_code, 3, 0, 0),
  [104] = {.entry = {.count = 1, .reusable = true}}, SHIFT(102),
  [106] = {.entry = {.count = 1, .reusable = true}}, SHIFT(107),
  [108] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_prologue, 3, 0, 0),
  [110] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 3, 0, 0),
  [112] = {.entry = {.count = 1, .reusable = true}}, SHIFT(94),
  [114] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 4, 0, 0),
  [116] = {.entry = {.count = 1, .reusable = true}}, SHIFT(92),
  [118] = {.entry = {.count = 1, .reusable = false}}, SHIFT(62),
  [120] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 4, 0, 0),
  ...
  [130] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment, 3, 0, 0),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__comments, 2, 0, 0),
  [134] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 1, 0, 0),
  [136] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 3, 0, 0),
  ...
  [144] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 4, 0, 0),
  [146] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 7, 0, 0),
  [148] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 5, 0, 0),
  [150] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 8, 0, 0),
  [152] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 9, 0, 0),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 6, 0, 0),
  [156] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 5, 0, 0),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 3, 0, 0),
  [160] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 3, 0, 0),
  ...
  [168] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alias, 4, 0, 0),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 2, 0, 0),
  [172] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 2, 0, 0),
  [174] = {.entry = {.count = 1, .reusable = true}}, SHIFT(40),
  [176] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alias, 3, 0, 0),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 4, 0, 0),
  [180] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 4, 0, 0),
  [182] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_alias, 2, 0, 0),
  [184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 1, 0, 0),
  [186] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 1, 0, 0),

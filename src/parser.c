...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(121)] = 2381,
  [SMALL_STATE(122)] = 2389,
  [SMALL_STATE(123)] = 2397,
  [SMALL_STATE(124)] = 2405,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [41] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(18),
  [44] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0),
  [46] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(155),
  [49] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(135),
  [52] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(67),
  [55] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(19),
  [58] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(168),
  [61] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_section2_repeat1, 2, 0, 0), SHIFT_REPEAT(140),
  ...
  [92] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_state_repeat1, 2, 0, 0), SHIFT_REPEAT(17),
  [95] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_state_repeat1, 2, 0, 0), SHIFT_REPEAT(155),
  [98] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_state_repeat1, 2, 0, 0), SHIFT_REPEAT(135),
  [101] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_state_repeat1, 2, 0, 0),
  [103] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_state_repeat1, 2, 0, 0), SHIFT_REPEAT(67),
  [106] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_state_repeat1, 2, 0, 0), SHIFT_REPEAT(19),
  [109] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_state_repeat1, 2, 0, 0), SHIFT_REPEAT(168),
  [112] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0),
  [114] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(149),
  [117] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(151),
  [120] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(68),
  [123] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(14),
  [126] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(142),
  ...
  [153] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(155),
  [156] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(135),
  [159] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(67),
  [162] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(20),
  [165] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_rule_repeat1, 2, 0, 0), SHIFT_REPEAT(168),
  [168] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 4, 0, 0),
  [170] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 3, 0, 0),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__inline_comments, 2, 0, 0),
  [174] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__inline_comments, 2, 0, 0), SHIFT_REPEAT(130),
  [177] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__inline_comments, 2, 0, 0),
  [179] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 2, 0, 0),
  [181] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_state, 4, 0, 0),
  [183] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__declaration, 4, 0, 0),
  [185] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__declaration, 5, 0, 0),
  [187] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 1, 0, 0),
  [189] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__declaration, 6, 0, 0),
  [191] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_state, 6, 0, 0),
  [193] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section1, 1, 0, 0),
  [195] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_state, 7, 0, 0),
  [197] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_state, 8, 0, 0),
  [199] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_interpolation, 3, 0, 0),
  [201] = {.entry = {.count = 1, .reusable = false}}, SHIFT(42),
  [203] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__inline_comments, 1, 0, 0),
  [205] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_escaped, 2, 0, 0),
  [207] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__bracketed, 2, 0, 0),
  [209] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 3, 0, 0),
  [211] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment, 3, 0, 0),
  [213] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__bracketed, 3, 0, 0),
  [215] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment, 2, 0, 0),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__declaration, 6, 0, 0),
  [219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_state_repeat1, 1, 0, 1),
  [221] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_state_repeat1, 1, 0, 1),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__declaration, 4, 0, 0),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__declaration, 5, 0, 0),
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_escaped, 2, 0, 0),
  ...
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__bracketed, 3, 0, 0),
  ...
  [249] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_section1_repeat1, 2, 0, 0), SHIFT_REPEAT(7),
  [252] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_section1_repeat1, 2, 0, 0), SHIFT_REPEAT(73),
  [255] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_section1_repeat1, 2, 0, 0), SHIFT_REPEAT(170),
  [258] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_section1_repeat1, 2, 0, 0),
  [260] = {.entry = {.count = 1, .reusable = true}}, SHIFT(64),
  [262] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_section1_repeat1, 1, 0, 0),
  ...
  [270] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__bracketed_tokens, 2, 0, 0),
  [272] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__bracketed_tokens_repeat1, 2, 0, 0), SHIFT_REPEAT(166),
  [275] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__bracketed_tokens_repeat1, 2, 0, 0), SHIFT_REPEAT(61),
  [278] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__bracketed_tokens_repeat1, 2, 0, 0),
  [280] = {.entry = {.count = 1, .reusable = false}}, SHIFT(60),
  [282] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__bracketed_tokens, 1, 0, 0),
  [284] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__comments, 2, 0, 0), SHIFT_REPEAT(127),
  [287] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__comments, 2, 0, 0),
  [289] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_section1_repeat1, 3, 0, 0),
  ...
  [297] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directive, 2, 0, 0),
  [299] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_directive, 2, 0, 0),
  [301] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition, 5, 0, 0),
  [303] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_definition, 5, 0, 0),
  [305] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_embedded_code, 1, 0, 0),
  [307] = {.entry = {.count = 1, .reusable = false}}, SHIFT(156),
  [309] = {.entry = {.count = 1, .reusable = false}}, SHIFT(75),
  [311] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directive, 4, 0, 0),
  [313] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_directive, 4, 0, 0),
  ...
  [323] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directive, 5, 0, 0),
  [325] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_directive, 5, 0, 0),
  [327] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_embedded_code_repeat1, 2, 0, 0),
  [329] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_embedded_code_repeat1, 2, 0, 0), SHIFT_REPEAT(156),
  [332] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_embedded_code_repeat1, 2, 0, 0), SHIFT_REPEAT(75),
  [335] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition, 6, 0, 0),
  [337] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_definition, 6, 0, 0),
  [339] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directive, 6, 0, 0),
  [341] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_directive, 6, 0, 0),
  [343] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directive, 3, 0, 0),
  [345] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_directive, 3, 0, 0),
  [347] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directive, 7, 0, 0),
  [349] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_directive, 7, 0, 0),
  [351] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prologue, 3, 0, 0),
  [353] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_prologue, 3, 0, 0),
  [355] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition, 7, 0, 0),
  [357] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_definition, 7, 0, 0),
  [359] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition, 2, 0, 0),
  [361] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_definition, 2, 0, 0),
  [363] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition, 3, 0, 0),
  [365] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_definition, 3, 0, 0),
  [367] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition, 4, 0, 0),
  [369] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_definition, 4, 0, 0),
  [371] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__inline_comments, 2, 0, 0), SHIFT_REPEAT(133),
  ...
  [418] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__embedded_code, 3, 0, 0),
  ...
  [430] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 4, 0, 0),
  [432] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 4, 0, 0),
  [434] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 3, 0, 0),
  [436] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 3, 0, 0),
  [438] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section2, 2, 0, 0),
  [440] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_section2, 2, 0, 0),
  ...
  [456] = {.entry = {.count = 1, .reusable = false}}, SHIFT(153),
  ...
  [560] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 4, 0, 0),
